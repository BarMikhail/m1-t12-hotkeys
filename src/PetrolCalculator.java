...
public class PetrolCalculator {
    public void calculateLoop() {
        ...
        for (int i = 0; i < iterationsCount; i++) {
            ...
            if (petrolType == 1) {
                double price = new Ai92Calculator().calculate(volum);
                System.out.println("Стоимость " + volum + " литров АИ-92 = " + price + "₽");
            } else if (petrolType == 2) {
                double price = new Ai95Calculator().calculate(volum);
                System.out.println("Стоимость " + volum + " литров АИ-95 = " + price + "₽");
            }
        }
    }
